export class Sublease {
  ...
  constructor(id: number, email: string, address: string, description: string, price: number, roommates: Roommate[], isFurnished: boolean, openHouse: Date, tags: string[], imageUrl: string) {
    this.id = id;
    this.email = email;
